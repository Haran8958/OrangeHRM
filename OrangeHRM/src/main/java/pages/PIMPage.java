...
private WebDriver driver;
	...
	public void enterFirstName(String firstname) {
		...
		waitUtil.waitForElementVisible(txtFirstName).sendKeys(firstname);
		logger.info("Firstname Entered");
	}
	
	public void enterMiddleName(String middlename) {
		logger.info("Entering Middlename");
		waitUtil.waitForElementVisible(txtMiddleName).sendKeys(middlename);
		logger.info("Middlename Entered");
	}
	
	public void enterLastName(String lastname) {
		logger.info("Entering Lastname");
		waitUtil.waitForElementVisible(txtLastName).sendKeys(lastname);
	...
	public void clickbtnSave() {
		...
		waitUtil.waitForElementClickable(btnSave).click();
	...
	public String getPerDet() {
		...
		WebElement element = waitUtil.waitForElementVisible(lblPerDet);
		return element.getText();
	}
	
	public String getEmpName() {
		WebElement employeeName = driver.findElement(lblEmpName);
	    waitUtil.waitForElementVisible(lblEmpName);
